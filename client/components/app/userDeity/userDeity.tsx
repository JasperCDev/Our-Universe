...
import { UserDeityContainer, UserClicksSubheading, UserDeityButton, UserDeityDiv, UserDeityEnergyBall } from './userDeity.styles';
...
const UserDeity: React.FC<Props> = ({
  ...
  return (
    <UserDeityContainer>
      <UserDeityDiv>
      <UserDeityEnergyBall></UserDeityEnergyBall>
      </UserDeityDiv>
